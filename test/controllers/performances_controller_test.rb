...
class PerformancesControllerTest < ActionController::TestCase
  ...
  test "should create performance" do
    assert_difference('Performance.count') do
      post :create, performance: { caption: @performance.caption, link_to_buy: @performance.link_to_buy, title: @performance.title }
    end
  ...
  test "should update performance" do
    patch :update, id: @performance, performance: { caption: @performance.caption, link_to_buy: @performance.link_to_buy, title: @performance.title }
    assert_redirected_to performance_path(assigns(:performance))
  end
